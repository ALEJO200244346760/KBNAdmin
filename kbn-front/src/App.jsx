...
const DARK_ONLY = ['/inicio', '/secretaria', '/monitor'];
      ...
      <HashRouter>
        ...
        <div style={{
          ...
          <Routes>
            ...
            {/* MONITOR — calendario de operaciones */}
            ...
            {/* MIS ESTADÍSTICAS — para instructores (redirige a su vista) */}
            <Route path="/mis-stats" element={
              <PrivateRoute allowedRoles={['ADMINISTRADOR','INSTRUCTOR']}>
                <InstructorForm />
              </PrivateRoute>
            } />
